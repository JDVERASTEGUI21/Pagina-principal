...
if (isset ($_GET['txtID'])){
  $txtID=(isset($_GET['txtID']) )?$_GET['txtID']:"";
    ...
    $sentencia=$conexion->prepare("SELECT * FROM tb_servicios WHERE id=:id");
...
if($_POST){
    ...
    $sentencia=$conexion->prepare("UPDATE tb_servicios 
    SET icono=:icono, titulo=:titulo, descripcion=:descripcion WHERE id=:id ");
