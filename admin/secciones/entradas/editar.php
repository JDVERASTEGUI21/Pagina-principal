<?php 
 ...
 if (isset ($_GET['txtID'])){
  $txtID=(isset($_GET['txtID']) )?$_GET['txtID']:"";
    ...
    $sentencia=$conexion->prepare("SELECT * FROM tb_entradas WHERE id=:id");
 ...
 if ($_POST) {
  ...
  $sentencia = $conexion->prepare("UPDATE `tb_entradas`
  SET 
  fecha = :fecha, 
  titulo = :titulo, 
  ...
  if($_FILES["imagen"]["name"]!=""){
    ...
    $sentencia = $conexion->prepare("UPDATE tb_entradas SET imagen=:imagen WHERE id=:id");
